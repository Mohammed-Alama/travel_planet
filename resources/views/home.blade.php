    ...
    <div class="jumbotron text-light" style="background-image: url('https://source.unsplash.com/1600x900/?nature')">
        <div class="container">
            @if(Auth::user())
                ...
                <a href="{{route('dashboard')}}" class="btn btn-success btn-lg my-2">View your Dashboard</a>
            @else
                ...
                <a href="{{route('login')}}" class="btn btn-success btn-lg my-2">Sign Up for Access to Thousands of Hotels</a>
            @endif
        </div>
    </div>
    <div class="container">
